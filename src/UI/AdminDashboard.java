...
public class AdminDashboard extends JPanel {
    ...
    public AdminDashboard(CardLayout layout, JPanel container, SkyPortManager manager) {
        ...
        // ✅ Create AdmView once so it can be refreshed later
        AdmView admView = new AdmView(manager);

        // Add panels
        mainPanel.add(new AdminAddFlight(manager, admView), "add");
        mainPanel.add(new AdmEdit(manager), "edit");
        mainPanel.add(new AdmEdit(manager), "delete");
        mainPanel.add(new AdmViewPassengers(manager), "viewPassengers");
