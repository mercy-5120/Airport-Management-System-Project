...
public class PassengerDashboard extends JPanel {
    public PassengerDashboard(String username, CardLayout layout, JPanel container) {
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            ...
            frame.setContentPane(new PassengerDashboard("UserName", frame.getContentPane().getLayout(), frame.getContentPane()));
